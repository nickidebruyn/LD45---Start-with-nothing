 ...
 * @author NideBruyn
 */
public class GameCompletedDialog extends PopupDialog {
    
    private Label message;
    private Button exitButton;
    private Button retryButton; 
    
    public GameCompletedDialog(Window window) {
        super(window, "Interface/black.png", window.getWidth(), window.getHeight());
        
        setTitle("GAME COMPLETED");
        setTitleColor(ColorRGBA.Green);
        setTitleSize(40);
        title.centerTop(0, 50);
        
        message = new Label(this, "Well done you have successfully escaped.\n\n"
